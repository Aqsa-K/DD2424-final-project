...
# AUGMENTATION
IMAGE_SIZE = 32 #48  # We will resize input images to this size.
PATCH_SIZE = 2 #6  # Size of the patches to be extracted from the input images.
NUM_PATCHES = (IMAGE_SIZE // PATCH_SIZE) ** 2
MASK_PROPORTION = 0.75  # We have found 75% masking to give us the best results.

# ENCODER and DECODER
LAYER_NORM_EPS = 1e-6
ENC_PROJECTION_DIM = 192 #128
DEC_PROJECTION_DIM =  192 #64
ENC_NUM_HEADS = 3 # 4
ENC_LAYERS = 12 #6
DEC_NUM_HEADS = 3 #4
DEC_LAYERS = (
